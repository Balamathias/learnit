...
const ResultsCard = ({ accuracy }: Props) => {
  return (
    <Card className="md:col-span-7 py-8">
        ...
        {accuracy > 75 ? (
          <>
            ...
            <div className="flex flex-col text-2xl font-semibold text-yellow-400">
              <span className="">Oh Weldone! You smashed it!</span>
          ...
          <>
            ...
            <div className="flex flex-col text-2xl font-semibold text-stone-400">
              <span className="">You did it, Good job! Better scores next time.</span>
              <span className="text-sm text-center opacity-50">
                {"> 25% accuracy"}
              </span>
            </div>
          ...
          <>
            <Trophy className="mr-4 mb-4" stroke="brown" size={50} />
            <div className="flex flex-col text-2xl font-semibold text-yellow-800">
              <span className="">Well, Nice try! We won&quot;t judge... You know what to do next time.</span>
